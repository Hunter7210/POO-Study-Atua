...
public class CardsLayout extends JFrame { // Criou uma classe que é um JFrame(uma janela)
    // DECLARANDO
    JPanel cards; // Deu nome a uma JPANEL;
    private String buttonPanel = "Card com JButtons";
    private String textPanel = "Card com JTextField";

    public CardsLayout() { // Chamando o construtor
        super("");
